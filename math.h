...
#define __MATH_TG(TG_ARG, FUNC, ARGS)                                          \
  (sizeof(TG_ARG) == sizeof(float)    ? FUNC##f ARGS                           \
   : sizeof(TG_ARG) == sizeof(double) ? FUNC ARGS                              \
                                      : FUNC##l ARGS)
#endif
...
extern "C++" {
#ifdef __SUPPORT_SNAN__
inline int iszero(float __val) { return __fpclassifyf(__val) == FP_ZERO; }
inline int iszero(double __val) { return __fpclassify(__val) == FP_ZERO; }
